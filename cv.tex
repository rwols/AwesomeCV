...
\begin{describesection}
  ...
  \leftside{from \textbf{jan 2017} to \textbf{juli 2017}}
...
\begin{describesection}
  ...
  \rightsideplain{Little experience.}
\end{describesection}
...
\rightsideplain{I have worked with various tools. Here are the most important ones that I have experience with: Visual Studio, Xcode, Sublime Text (my favourite right now), clang, clang-cl, gcc, cl, msbuild, ninja, cmake, gdb, lldb.}
\end{describesection}
